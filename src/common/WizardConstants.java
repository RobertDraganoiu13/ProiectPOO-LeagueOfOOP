...
public class WizardConstants {
    ...
    public static final float WIZARD_BONUS_TERRAIN_PERCENTAGE = 1.1f;

    public static final float WIZARD_ABILITY1_BASE_PERCENTAGE = 1.2f;
    public static final float WIZARD_ABILITY1_LEVEL_BONUS_MODIFIER = 1.5f;
    ...
    public static final float WIZARD_ABILITY2_BASE_PERCENTAGE = 1.35f;
    public static final float WIZARD_ABILITY2_LEVEL_BONUS_MODIFIER = 0.02f;
    public static final float WIZARD_ABILITY2_MAX_PERCENTAGE_MODIFIER = 0.7f;
